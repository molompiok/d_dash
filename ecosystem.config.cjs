  ...
  apps: [
    {
      ...
      args: 'assignment:worker', // <--- La commande Ace est maintenant l'argument
    ...
    },
    {
      ...
      script: aceScript,          // <--- Pointe vers le fichier ace.js ou bin/ace.js
      args: 'notification:worker', // <--- La commande Ace est maintenant l'argument
      interpreter: 'node',
      exec_mode: 'fork',
      instances: 1,
      autorestart: true,
    ...
    },
    {
      ...
      script: aceScript,               // <--- Pointe vers le fichier ace.js ou bin/ace.js
      args: 'availability:sync-status', // <--- La commande Ace est maintenant l'argument
      interpreter: 'node',
      exec_mode: 'fork',
